...
search_agent = Agent(
    ...
    name='search_agent',
    description="Agent um Informationen zur Firma Huber SE im Internet zu finden.",
    instruction="""
    Du bist ein hilfsbereiter, freundlicher Such-Agent.
    Suche auf der Website www.huber.de nach Informationen zur Firma Huber SE.
    Bitte suche in deutscher Sprache.
    """,
...
async def get_agent_async():
    ...
    root_agent = Agent(
        name="chat_enquiry_agent",
        model="gemini-2.0-flash",
        description=("Agent um Anfragen von Kunden via Chat zu beantworten."),
        ...
        Mitarbeiter weiterleiten wirst.
         ...
         Du kannst folgende Tools zur Unterstützung deiner Aufgaben verwenden:
            ...
            - search_agent: Finde weitere Informationen zur Firma Huber im Internet.
            - search_customer: Sucht nach einem Kunden im CRM System und gibt die Kundendaten zurück.
        """,
        tools=[company_info, product_details, AgentTool(agent=search_agent)] + tools
    )
